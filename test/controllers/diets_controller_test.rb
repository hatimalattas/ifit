...
class DietsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post diets_url, params: { diet: { description: @diet.description, name: @diet.name, picture: @diet.picture } }
    end
  ...
  test "should update diet" do
    patch diet_url(@diet), params: { diet: { description: @diet.description, name: @diet.name, picture: @diet.picture } }
